...
let questions = [
    ...
    },
    {
        ...
        answers: ["rock", "jaz", "gosple", "instrumental"],
        correctAnswer: 2
    },
    {
    ...
    {
        question: "do I like codeing",
        answers: ["yes", "no", "i dont know", "not sure"],
        correctAnswer: 0
    }
];
...
function getquestion() {
    ...
    var newQuestion = questions[currentQuestions]
    questionTitleEl.textContent = questions[currentQuestions].question
